...
export default function ConvertToPDF() {
    return (
        ...
        <div className="section-header mb-4" >
            <span className="section-header-text text-3xl font-semibold tracking-tight text-gray-900 dark:text-white" >Convert to PDF</span>
        </div>
            ...
            <div className="section-cards" >
                <div className="" >
                    ...
                    <svg className="w-10 h-10 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Word to PDF</h5>
                        </a>
                ...
                <div className="" >
                    ...
                    <svg className="w-10 h-10 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">PPT to PDF</h5>
                        </a>
                ...
                <div className="" >
                    ...
                    <svg className="w-10 h-10 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Excel to PDF</h5>
                        </a>
                ...
                <div className="" >
                    ...
                    <svg className="w-10 h-10 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">JPG to PDF</h5>
                        </a>
                ...
                <div className="" >
                    <div className="section-card max-w-sm p-6 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a href="#">
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">TXT to PDF</h5>
                        </a>
